...
public class UserServiceImpl implements UserService {
    ...
    public BaseResponseDTO registerAccount(UserDTO userDTO) {
        ...
        validateAccount(userDTO);  // KEEP THIS
...
//        userDTO.setUserId(user.getId());
//
//        // Set basic fields from User entity
//        userDTO.setEmail(user.getEmail());
//        userDTO.setMobileNumber(user.getMobileNumber());
//
...
//        userDTO.setRoles(roles);
//
//        // Set role and gender from UserProfile if exists
//        if (roles.contains("USER")) {
//            UserProfile userProfile = userProfileRepository.findByUserId(user.getId().intValue());
//            if (userProfile != null) {
//                userDTO.setGender(userProfile.getGender());
//                userDTO.setRole("USER"); // main role
//            } else {
//                // fallback if no profile
//                userDTO.setGender(user.getGender());
//                userDTO.setRole(roles.iterator().next()); // first role
//            }
//        } else {
...
//        }
        ...
        if (request.getMobileNumber() != null) {
            user.setMobileNumber(String.valueOf(request.getMobileNumber()));
        }
